// $Id: AtomDescendantEnumeration.java,v 1.8 1999/03/11 10:41:09 alex Exp $
// Enumerate descendants of an atom
// James Fryer, 23 June 98
...
*/
final class AtomDescendantEnumeration
    ...
    */
    ...
    public AtomDescendantEnumeration(Atom start)
        {
        // Initialise and put the first atom onto the queue
        Atom.clearAllMarks();

        // Create the queue (with reversed priority)
        ...
        if (queueSize < 1)
            queueSize = 100;
        queue = new AtomQueue(queueSize, true);
    ...
    public Object nextElement()
        ...
        Enumeration e = result.getChildren();
